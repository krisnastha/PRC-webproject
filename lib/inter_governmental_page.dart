...
class InterGovernmentalPage extends StatefulWidget {
  const InterGovernmentalPage({super.key});
  @override
  State<InterGovernmentalPage> createState() => _InterGovernmentalPageState();
}

class _InterGovernmentalPageState extends State<InterGovernmentalPage> {
  ...
  child: Container(
    ...
    child: Image.asset(
      ...
      filterQuality: FilterQuality.high,
            ...
            width: double.infinity,
            child: Center(child: Text("Inter Governmental Relation Page", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
            ),
            Container(
