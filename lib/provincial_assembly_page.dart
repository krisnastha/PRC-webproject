...
class ProvincialAssemblyPage extends StatefulWidget {
  const ProvincialAssemblyPage({super.key});
  @override
  State<ProvincialAssemblyPage> createState() => _ProvincialAssemblyPageState();
}

class _ProvincialAssemblyPageState extends State<ProvincialAssemblyPage> {
  ...
  child: Container(
    ...
    child: Image.asset(
      ...
      filterQuality: FilterQuality.high,
            ...
            width: double.infinity,
            child: Center(child: Text("Provincial Governmental Page", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
            ),
            Container(
